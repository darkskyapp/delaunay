...
(function() {
  ...
  var Simplex = function(indices, vertices, n) {
        ...
        console.log(Math.sqrt(this.radius));
      };
  ...
  Delaunay = {
    ...
    triangulate: function(objects, key) {
      ...
      Array.prototype.push.apply(
        objects,
        Delaunay.boundingSimplex(objects, n, 32)
      );
